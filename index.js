/*
Imported the packages we need in order to work with APIs and in order to work specifically with Notion API
*/
require("dotenv").config()
const axios = require("axios")
const { Client } = require("@notionhq/client")

// Imported the Notion private client key we got from the integration
